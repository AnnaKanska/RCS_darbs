    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-lg-9">
                ...
                <div class="card">
                        <div class="card-body {{ ($todoitem->is_done)?'is-done':'' }}">
                            <button type="button" class="close" aria-label="Close">
                                <a href="delete/{{$todoitem->id}}"><span aria-hidden="true">&times;</span></a>
                            </button>
                            ...
                            <p class="card-text">
                            	...
                            	<a href="toggle/{{$todoitem->id}}" class="doneTask">Done</a>
                            </p>
                        </div>
                    </div>
            ...
            <div class="modal-content">
                ...
                {{csrf_field()}}
                    ...
                    <div class="modal-body">
                        <textarea name="body" class="form-control" id="noteTextArea" rows="10"></textarea>
                    </div>
